...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("gnrccc@gmail.com");
    setHasCopied(true);
    ...
    <section className="sm:px-10 px-5 my-20" id="about">
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="w-full h-full border border-gray-900 bg-black rounded-lg sm:p-7 p-4 flex flex-col gap-5">
            <img
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="w-full h-full border border-gray-900 bg-black rounded-lg sm:p-7 p-4 flex flex-col gap-5">
            ...
            <div>
              ...
              <p className="text-[#afb0b6] text-base">
                I love solving problems and building things through code (using
                LLM). I am passionate about creating efficient and scalable
                solutions that make a difference in people's lives. I am always
                eager to learn new technologies and improve my skills. I am also
                a big fan of open-source projects and enjoy contributing to the
                community.
              </p>
            </div>
          </div>
